...
namespace DL
{
    public interface IOrderDL
    {
        ...
        public Task<List<Order>> getOrdersByQeryParams(string hotelName, string customerName, int page);
        ...
        public Task<List<Order>> getOrdersBetweenDates(string hotelName, string customerName, DateTime start, DateTime end, int page);
    }
}
